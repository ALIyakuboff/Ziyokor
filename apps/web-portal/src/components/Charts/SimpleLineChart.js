...
export default function SimpleLineChart({ points, height = 120 }) {
    ...
    return (_jsxs("div", { className: "chartBox", children: [_jsx("canvas", { ref: ref, width: 360, height: height }), _jsx("div", { className: "chartLabels", children: points.map((p) => (_jsx("div", { className: "chartLabel", children: p.label }, p.label))) })] }));
}
