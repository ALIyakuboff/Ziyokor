...
export default function ProductivityChart({ range, anchor, workerId }) {
    ...
    return (_jsx("div", { style: { position: 'relative' }, children: _jsx(SimpleBarChart, { points: points, max: 100 }) }));
}
