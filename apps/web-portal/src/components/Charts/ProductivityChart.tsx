...
export default function ProductivityChart({ range, anchor, workerId }: { range: "week" | "month" | "year"; anchor: string; workerId?: string }) {
    ...
    return (
        <div style={{ position: 'relative' }}>
            <SimpleBarChart points={points} max={100} />
        </div>
    );
}
