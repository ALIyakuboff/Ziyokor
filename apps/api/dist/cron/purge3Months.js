...
exports.purge3MonthsJob = purge3MonthsJob;
const db_1 = require("../db");
// Delete data older than 3 months.
// We keep users + templates.
// We hard-delete tasks; comments are ON DELETE CASCADE.
async function purge3MonthsJob() {
    const r = await (0, db_1.query)(`WITH deleted AS (
       DELETE FROM tasks
    ...
    const r2 = await (0, db_1.query)(`WITH deleted AS (
