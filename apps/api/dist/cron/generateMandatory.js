...
exports.generateMandatoryJob = generateMandatoryJob;
...
async function generateMandatoryJob(date) {
    ...
    for (const tpl of templates.rows) {
       ...
       VALUES
        ($1,$2,$3,'pending',$4,$4,false,NULL,$5,false,'admin',$6)`, [tpl.user_id, tpl.title, tpl.is_mandatory, date, tpl.id, tpl.created_by_admin_id]);
        created++;
    }
